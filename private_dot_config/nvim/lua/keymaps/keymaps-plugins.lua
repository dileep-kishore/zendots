...
map("n", "<leader>lD", "<cmd>lua vim.diagnostic.enable(false)<CR>", { desc = "Disable LSP in current buffer" })
...
map("n", "<leader>pl", "<cmd>AutoSession restore<cr>", { desc = "AutoSession Load" })
map("n", "<leader>ps", "<cmd>AutoSession save<cr>", { desc = "AutoSession Save" })
map("n", "<leader>pt", "<cmd>AutoSession toggle<cr>", { desc = "AutoSession Toggle" })
map("n", "<leader>pd", "<cmd>AutoSession delete<cr>", { desc = "AutoSession Delete" })
map("n", "<leader>pD", "<cmd>AutoSession deletePicker<cr>", { desc = "AutoSession Delete (pick)" })
map("n", "<leader>pp", "<cmd>AutoSession search<cr>", { desc = "AutoSession Pick" })
map("n", "<leader>e", "<cmd>lua MiniSnippets.expand()<cr>", { desc = "MiniSnippets expand" })
